...
<li><input type="checkbox" id="accordion1"><label style="line-height:2;margin-top:15px; font-family:sans-serif;" for="accordion1">For Staff</label>
<div>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="https://intranet.moe.gov.sg/">MOE Intranet</a>
<br><br>
...
<li><input type="checkbox" id="accordion2"> <label style="font-family:sans-serif;;" for="accordion2">For Students</label>
<div>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="https://learning.moe.edu.sg/">Student Learning Space</a>
	<br><br>
